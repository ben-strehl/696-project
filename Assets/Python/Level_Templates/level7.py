...
#     if sprinkles == True:
#         return ["Egg", "Milk", "Flour", "Sugar", "Sprinkles", "Frosting"]
#     else:
#         return ["Egg", "Milk", "Flour", "Sugar", "Frosting"]

# 'build_Cake' is the name of our function. It accepts an 
# argument, which we call 'sprinkles'. 
# sprinkles can be True or False.
...
# ["Egg", "Milk", "Flour", "Sugar", "Sprinkles", "Frosting"]
...
# We can put function calls inside of function calls to 
# immediately use their return values.
