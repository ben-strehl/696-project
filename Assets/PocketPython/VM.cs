...
namespace PocketPython
{
    public partial class VM
    {
        ...
        public object NewTypeObject(PyModule module, string name, PyTypeObject @base)
        {
            string fullname;
        ...
        {
            Bindings.pkpy_vm_compile(p, source, filename, (int)mode, out bool ok, out string res);
            if (ok)
            {
